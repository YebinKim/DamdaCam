...
class ARViewController: UIViewController {
    ...
    static let identifier: String = "ARViewController"
    ...
    var uiViewController: ARDrawingViewController?
    ...
    func setupUI() {
        ...
        let uiStoryboard = UIStoryboard(name: "ARDrawingViewController", bundle: nil)
        uiViewController = uiStoryboard.instantiateInitialViewController() as? ARDrawingViewController
